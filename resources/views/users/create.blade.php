    ...
    <x-card class="container mx-auto mt-10 mb-10 max-w-lg">
        <form action="{{ route('users.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <br>
                <input class="w-full" type="text" name="name" id="name" value="{{ old('name') }}">
                @error('name')
            ...
            <div class="mb-4">
                ...
                <br>
                <input class="w-full" type="text" name="last_name" id="last_name" value="{{ old('last_name') }}">
                @error('last_name')
                    <p class="error">{{ $message }}</p>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <br>
                <input class="w-full" type="text" name="email" id="email" value="{{ old('email') }}">
                @error('email')
                    <p class="error">{{ $message }}</p>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <br>
                <input class="w-full" type="password" name="password" id="password" value="{{ old('password') }}">
                @error('password')
                    <p class="error">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex gap-2 mt-4">
                <button type="submit"
                    class="rounded-md w-full px-2 py-1 text-center font-medium text-white bg-blue-700 shadow-sm ring-1 ring-slate-700/10 hover:bg-blue-900">Save</button>
